...
const std::vector<unsigned int> &PmergeMe::getMyVector() const
{ return _vector; }

const std::deque<unsigned int> &PmergeMe::getMyDeque() const
{ return _deq; }

long int PmergeMe::getMyStraggler() const
{ return _straggler; }

const vectorPairs &PmergeMe::getSortedPairs() const
{ return _sortedPairs_vector; }

std::vector<unsigned int> &PmergeMe::getMyVector()
{ return _vector; }

std::deque<unsigned int> &PmergeMe::getMyDeque()
{ return _deq; }

long int &PmergeMe::getMyStraggler()
{ return _straggler; }

vectorPairs &PmergeMe::getSortedPairs()
{ return _sortedPairs_vector; }
...
std::vector<int> PmergeMe::generateJacobsthal()
{
